...
<body>
    ...
    <main class="ok-page">
        <div class="text-balloon">
            <p>- You decided to follow the {{$user->track}} track, which will bring lots of new tools and frameworks to work on.<br>
        ...
        <div class="terminal">
            ...
            <div class="content">
                ...
                <button class="skipBtn" id="hoverOnlyButton">> Ready when you are!</button>
            </div>
        </div>
